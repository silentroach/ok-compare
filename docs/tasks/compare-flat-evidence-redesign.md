...
| T3  | [Flatten explorer controls and map panel](compare-flat-evidence-redesign/T3-flatten-explorer-map.md)           | done   | T1           |
| T4  | [Flatten settlement result cards](compare-flat-evidence-redesign/T4-flatten-settlement-cards.md)               | done   | T1           |
| T5  | [Run integrated QA and close out redesign docs](compare-flat-evidence-redesign/T5-integrated-qa-closeout.md)   | done   | T2, T3, T4   |
...
- [x] Hero, KPI summary, explorer controls, map and settlement cards all use the same flat-first vocabulary.
- [x] Component tests and `typecheck` pass or gaps are documented.
