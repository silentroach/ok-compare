...
Отклонения: serializer-owned Markdown теперь использует autolink для URL, экранирует символы вроде `_` в текстовых id и хранит примечания source refs в title Markdown-ссылок.
