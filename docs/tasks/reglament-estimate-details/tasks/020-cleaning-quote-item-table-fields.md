...
- [ ] Multi-position `quote_items` in `apps/www/src/data/reglament/estimate-details-2026/cleaning.ts` include `quantity` with source unit where the PDF row has a quantity column.
...
- [ ] Tests cover at least one enriched cleaning PPE/resource-statement quote item.
