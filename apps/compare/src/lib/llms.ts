  ...
  const body =
    kind === 'short'
      ? [
          ...
          '',
          'Описание',
          '- Статический сайт для сравнения тарифов на содержание коттеджных поселков с Шелково.',
      ...
      : [
          ...
          '',
          'Проект',
          '- Это статический русскоязычный сайт для сравнения тарифов на содержание коттеджных поселков с Шелково.',
