...
- Интегрированный root workflow workspace тоже использует `4321`, а `/815/compare` приходит туда проксием из `apps/compare`.
...
- Compare должен подключаться как готовый section build по пути `/815/compare`.
