  ...
  'производственная программа / СИЗ для ухода за деревьями',
  {
    ...
    quote_items: detailSourceQuoteItems(
      detailSourceQuoteItem({
        ...
        quote: 'Костюм хлопчатобумажный 0,5',
      ...
      detailSourceQuoteItem({
        ...
        quantity: detailQuantity(0.21, 'шт.', { raw: '0,21' }),
      }),
      detailSourceQuoteItem({
      ...
      detailSourceQuoteItem({
        ...
        quantity: detailQuantity(2.1, 'шт.', { raw: '2,1' }),
      }),
      detailSourceQuoteItem({
      ...
      detailSourceQuoteItem({
        ...
        quantity: detailQuantity(6.4, 'шт.', { raw: '6,4' }),
      }),
    ),
  },
);
  ...
  'производственная программа / обработка от клещей и борьба с борщевиком',
  {
    ...
    quote_items: detailSourceQuoteItems(
      detailSourceQuoteItem({
        ...
        quote:
          'Обработка от клещей; V-X; кратность 1; услуга сторонней организации 34200,00',
        resource_ids: [landscapingTicksTreatmentContractorResourceId],
        quantity: detailQuantity(1, 'обработка', { raw: '1,0' }),
        unit_price_rub: detailMoney(34_200, { raw: '34200,00' }),
        total_rub: detailMoney(34_200, { raw: '34 200,00' }),
      }),
      detailSourceQuoteItem({
        label: 'Услуги сторонней организации: борьба с борщевиком',
        quote:
          'Борьба с борщевиком; V-X; кратность 3; услуга сторонней организации 5826000,00',
        resource_ids: [landscapingHogweedContractorResourceId],
        quantity: detailQuantity(1, 'обработка', { raw: '1,0' }),
        unit_price_rub: detailMoney(5_826_000, { raw: '5826000,00' }),
        total_rub: detailMoney(5_826_000, { raw: '5 826 000,00' }),
      }),
    ),
  },
);
  ...
  'нормативное штатное расписание по озеленению',
  {
    ...
    quote_items: detailSourceQuoteItems(
      detailSourceQuoteItem({
        ...
        quote: 'Рабочий по уборке территории ... 0,95 ... 664,15',
        quantity: detailQuantity(0.95, 'чел.', { raw: '0,95' }),
        unit_price_rub: detailMoney(664.15, { raw: '664,15' }),
      }),
      detailSourceQuoteItem({
        label: 'Машинист',
        quote: 'Машинист 0,08 ... 934,32',
        quantity: detailQuantity(0.08, 'чел.', { raw: '0,08' }),
...
const landscapingResourceStatementSource = detailSource(
  ...
  'ресурсная ведомость по локальному ресурсному сметному расчету',
  {
    ...
    quote_items: detailSourceQuoteItems(
      detailSourceQuoteItem({
        label: 'Рабочий',
        quote: 'Рабочий ... 1915,9 664,15 1 272 411,90',
        quantity: detailQuantity(1_915.9, 'чел-час', { raw: '1915,9' }),
        unit_price_rub: detailMoney(664.15, { raw: '664,15' }),
        total_rub: detailMoney(1_272_411.9, { raw: '1 272 411,90' }),
      }),
      detailSourceQuoteItem({
        label: 'Машинист',
        quote: 'Машинист 163,9 934,32 153 163,08',
        resource_ids: [landscapingTreesWaterMachinistResourceId],
        quantity: detailQuantity(163.9, 'чел-час', { raw: '163,9' }),
        unit_price_rub: detailMoney(934.32, { raw: '934,32' }),
        total_rub: detailMoney(153_163.08, { raw: '153 163,08' }),
      }),
      detailSourceQuoteItem({
      ...
      detailSourceQuoteItem({
        label: 'Вода',
        quote: 'Вода 291,0 13,56 3 945,96',
        resource_ids: [landscapingTreesWaterResourceId],
        quantity: detailQuantity(291, 'м³', { raw: '291,0' }),
        unit_price_rub: detailMoney(13.56, { raw: '13,56' }),
        total_rub: detailMoney(3_945.96, { raw: '3 945,96' }),
      }),
    ),
  },
);
...
export const landscapingResources = [
  detailResource({
    ...
    quantity: detailQuantity(1_030, 'чел-час', { raw: '1030' }),
    unit_price_rub: detailMoney(664.15, { raw: '664,15' }),
    total_rub: detailMoney(684_354.43, { raw: '684 354,43' }),
    source_refs: detailSourceRefs(
      landscapingProductionMowingSource,
  ...
  detailResource({
    ...
    quantity: detailQuantity(1_030, 'маш-час', { raw: '1030' }),
    unit_price_rub: detailMoney(59.97, { raw: '59,97' }),
    total_rub: detailMoney(61_792.83, { raw: '61 792,83' }),
    source_refs: detailSourceRefs(
      landscapingProductionMowingSource,
  ...
  detailResource({
    ...
    quantity: detailQuantity(0.5, 'шт.', { raw: '0,5' }),
    unit_price_rub: detailMoney(5_500, { raw: '5500,00' }),
    total_rub: detailMoney(2_750, { raw: '2 750,00' }),
    source_refs: detailSourceRefs(
      landscapingMowingMachinePpeSource,
      landscapingResourceStatementSource,
    ),
  ...
  detailResource({
    ...
    unit_price_rub: detailMoney(6_000, { raw: '6000,00' }),
    total_rub: detailMoney(1_200, { raw: '1 200,00' }),
    source_refs: detailSourceRefs(
      landscapingMowingMachinePpeSource,
      landscapingResourceStatementSource,
    ),
  ...
  detailResource({
    ...
    quantity: detailQuantity(0.5, 'шт.', { raw: '0,5' }),
    unit_price_rub: detailMoney(1_200, { raw: '1200,00' }),
    total_rub: detailMoney(600, { raw: '600,00' }),
    source_refs: detailSourceRefs(
      landscapingMowingMachinePpeSource,
      landscapingResourceStatementSource,
    ),
  ...
  detailResource({
    ...
    quantity: detailQuantity(0.2, 'шт.', { raw: '0,2' }),
    unit_price_rub: detailMoney(3_500, { raw: '3500,00' }),
    total_rub: detailMoney(700, { raw: '700,00' }),
    source_refs: detailSourceRefs(
      landscapingMowingMachinePpeSource,
      landscapingResourceStatementSource,
    ),
  ...
  detailResource({
    ...
    quantity: detailQuantity(2, 'шт.', { raw: '2,0' }),
    unit_price_rub: detailMoney(700, { raw: '700,00' }),
    total_rub: detailMoney(1_400, { raw: '1 400,00' }),
    source_refs: detailSourceRefs(
      landscapingMowingMachinePpeSource,
      landscapingResourceStatementSource,
    ),
  ...
  detailResource({
    ...
    quantity: detailQuantity(0.5, 'шт.', { raw: '0,5' }),
    unit_price_rub: detailMoney(2_000, { raw: '2000,00' }),
    total_rub: detailMoney(1_000, { raw: '1 000,00' }),
    source_refs: detailSourceRefs(
      landscapingMowingMachinePpeSource,
      landscapingResourceStatementSource,
    ),
  ...
  detailResource({
    ...
    cost_bucket: 'materials',
    quantity: detailQuantity(6, 'шт.', { raw: '6,0' }),
    unit_price_rub: detailMoney(116, { raw: '116,00' }),
    total_rub: detailMoney(696, { raw: '696,00' }),
    source_refs: detailSourceRefs(
      landscapingMowingMachinePpeSource,
      landscapingResourceStatementSource,
    ),
  ...
  detailResource({
    ...
    total_rub: detailMoney(206_675.04, { raw: '206 675,04' }),
  ...
  detailResource({
    ...
    total_rub: detailMoney(479_048.1, { raw: '479 048,10' }),
    source_refs: detailSourceRefs(landscapingMowingMachinePpeSource),
    ...detailStatus('verified'),
  }),
  detailResource({
    ...
    cost_bucket: 'profit',
    total_rub: detailMoney(273_741.77, { raw: '273 741,77' }),
    source_refs: detailSourceRefs(landscapingMowingMachinePpeSource),
    ...detailStatus('verified'),
  }),
  detailResource({
  ...
  detailResource({
    ...
    quantity: detailQuantity(0.039, 'чел-час', { raw: '0,039' }),
    unit_price_rub: detailMoney(664.15, { raw: '664,15' }),
    total_rub: detailMoney(25.77, { raw: '25,77' }),
    source_refs: detailSourceRefs(
      landscapingProductionTreesFertilizerSource,
  ...
  detailResource({
    ...
    cost_bucket: 'machines',
    quantity: detailQuantity(164, 'маш-час', { raw: '164' }),
    unit_price_rub: detailMoney(1_476.02, { raw: '1476,02' }),
    total_rub: detailMoney(241_964.04, { raw: '241 964,04' }),
    source_refs: detailSourceRefs(
      landscapingProductionTreesWaterSource,
  ...
  detailResource({
    ...
    cost_bucket: 'primary_salary',
    quantity: detailQuantity(456, 'чел-час', { raw: '456' }),
    unit_price_rub: detailMoney(664.15, { raw: '664,15' }),
    total_rub: detailMoney(302_784.07, { raw: '302 784,07' }),
    source_refs: detailSourceRefs(
      landscapingProductionTreesLooseningSource,
  ...
  detailResource({
    ...
    cost_bucket: 'primary_salary',
    quantity: detailQuantity(6, 'чел-час', { raw: '6' }),
    unit_price_rub: detailMoney(664.15, { raw: '664,15' }),
    total_rub: detailMoney(3_865.33, { raw: '3 865,33' }),
    source_refs: detailSourceRefs(
      landscapingProductionTreesConiferSource,
  ...
  detailResource({
    ...
    cost_bucket: 'primary_salary',
    quantity: detailQuantity(1, 'чел-час', { raw: '1' }),
    unit_price_rub: detailMoney(664.15, { raw: '664,15' }),
    total_rub: detailMoney(644.22, { raw: '644,22' }),
    source_refs: detailSourceRefs(
      landscapingProductionTreesConiferSource,
  ...
  detailResource({
    ...
    quantity: detailQuantity(1, 'чел-час', { raw: '1' }),
    unit_price_rub: detailMoney(664.15, { raw: '664,15' }),
    total_rub: detailMoney(837.49, { raw: '837,49' }),
    source_refs: detailSourceRefs(
      landscapingProductionTreesConiferSource,
  ...
  detailResource({
    ...
    cost_bucket: 'primary_salary',
    quantity: detailQuantity(137, 'чел-час', { raw: '137' }),
    unit_price_rub: detailMoney(664.15, { raw: '664,15' }),
    total_rub: detailMoney(91_318.39, { raw: '91 318,39' }),
    source_refs: detailSourceRefs(
      landscapingProductionTreesWeedingSnowSource,
  ...
  detailResource({
    ...
    cost_bucket: 'primary_salary',
    quantity: detailQuantity(25, 'чел-час', { raw: '25' }),
    unit_price_rub: detailMoney(664.15, { raw: '664,15' }),
    total_rub: detailMoney(16_427.65, { raw: '16 427,65' }),
    source_refs: detailSourceRefs(
      landscapingProductionTreesWeedingSnowSource,
  ...
  detailResource({
    ...
    cost_bucket: 'materials',
    quantity: detailQuantity(38.8, 'кг.', { raw: '38,8' }),
    unit_price_rub: detailMoney(170, { raw: '170,00' }),
    total_rub: detailMoney(6_596, { raw: '6 596,00' }),
    source_refs: detailSourceRefs(
      landscapingProductionTreesFertilizerSource,
  ...
  detailResource({
    ...
    cost_bucket: 'materials',
    quantity: detailQuantity(38.8, 'кг.', { raw: '38,8' }),
    unit_price_rub: detailMoney(120, { raw: '120,00' }),
    total_rub: detailMoney(4_656, { raw: '4 656,00' }),
    source_refs: detailSourceRefs(
      landscapingProductionTreesFertilizerSource,
      landscapingTreesFertilizerMaterialsSource,
      landscapingResourceStatementSource,
  ...
  detailResource({
    ...
    unit_price_rub: detailMoney(1_500, { raw: '1500,00' }),
    total_rub: detailMoney(222.75, { raw: '222,75' }),
    source_refs: detailSourceRefs(
  ...
  detailResource({
    ...
    unit_price_rub: detailMoney(12_000, { raw: '12000,00' }),
    total_rub: detailMoney(1_620, { raw: '1 620,00' }),
    source_refs: detailSourceRefs(
      landscapingProductionTreesInventorySource,
  ...
  detailResource({
    ...
    unit_price_rub: detailMoney(1_200, { raw: '1200,00' }),
    total_rub: detailMoney(178.2, { raw: '178,20' }),
    source_refs: detailSourceRefs(
      landscapingProductionTreesInventorySource,
      landscapingTreesInventorySource,
      landscapingResourceStatementSource,
  ...
  detailResource({
    ...
    unit_price_rub: detailMoney(12_000, { raw: '12000,00' }),
    total_rub: detailMoney(1_782, { raw: '1 782,00' }),
    source_refs: detailSourceRefs(
      landscapingProductionTreesInventorySource,
      landscapingTreesInventorySource,
      landscapingResourceStatementSource,
  ...
  detailResource({
    ...
    unit_price_rub: detailMoney(6_000, { raw: '6000,00' }),
    total_rub: detailMoney(891, { raw: '891,00' }),
    source_refs: detailSourceRefs(
      landscapingProductionTreesInventorySource,
      landscapingTreesInventorySource,
      landscapingResourceStatementSource,
  ...
  detailResource({
    ...
    unit_price_rub: detailMoney(10_000, { raw: '10000,00' }),
    total_rub: detailMoney(1_485, { raw: '1 485,00' }),
    source_refs: detailSourceRefs(
      landscapingProductionTreesInventorySource,
      landscapingTreesInventorySource,
      landscapingResourceStatementSource,
  ...
  detailResource({
    ...
    cost_bucket: 'insurance',
    total_rub: detailMoney(171_857.92, { raw: '171 857,92' }),
  ...
  detailResource({
    ...
    cost_bucket: 'overhead',
    total_rub: detailMoney(398_346.19, { raw: '398 346,19' }),
    source_refs: detailSourceRefs(landscapingTreesTotalsSource),
    ...detailStatus('verified'),
  }),
  detailResource({
    ...
    cost_bucket: 'profit',
    total_rub: detailMoney(227_626.4, { raw: '227 626,40' }),
    source_refs: detailSourceRefs(landscapingTreesTotalsSource),
    ...detailStatus('verified'),
  }),
  detailResource({
  ...
  detailResource({
    ...
    cost_bucket: 'primary_salary',
    quantity: detailQuantity(259.212, 'чел-час', { raw: '259,212' }),
    unit_price_rub: detailMoney(664.15, { raw: '664,15' }),
    total_rub: detailMoney(172_154.56, { raw: '172 154,56' }),
    source_refs: detailSourceRefs(
      landscapingProductionForestSource,
      landscapingForestSource,
      landscapingResourceStatementSource,
  ...
  detailResource({
    ...
    cost_bucket: 'insurance',
    total_rub: detailMoney(51_990.68, { raw: '51 990,68' }),
  ...
  detailResource({
    ...
    cost_bucket: 'overhead',
    total_rub: detailMoney(120_508.19, { raw: '120 508,19' }),
    source_refs: detailSourceRefs(landscapingForestSource),
    ...detailStatus('verified'),
  }),
  detailResource({
    ...
    cost_bucket: 'profit',
    total_rub: detailMoney(68_861.82, { raw: '68 861,82' }),
    source_refs: detailSourceRefs(landscapingForestSource),
    ...detailStatus('verified'),
  }),
  detailResource({
...
export const landscapingControlTotals = [
  detailControlTotal({
    ...
    estimate_row_id: 'landscaping-mowing-ditches',
    cost_bucket: 'machinist_salary',
    source_total_rub: detailMoney(684_354.43, { raw: '684 354,43' }),
    detail_total_rub: detailMoney(684_354.43, { raw: '684 354,43' }),
  ...
  detailControlTotal({
    ...
    estimate_row_id: 'landscaping-mowing-ditches',
    cost_bucket: 'machines',
    source_total_rub: detailMoney(61_792.83, { raw: '61 792,83' }),
    detail_total_rub: detailMoney(61_792.83, { raw: '61 792,83' }),
  ...
  detailControlTotal({
    ...
    estimate_row_id: 'landscaping-mowing-ditches',
    cost_bucket: 'materials',
    source_total_rub: detailMoney(9_046, { raw: '9 046,00' }),
    detail_total_rub: detailMoney(9_046, { raw: '9 046,00' }),
  ...
  detailControlTotal({
    ...
    estimate_row_id: 'landscaping-mowing-ditches',
    cost_bucket: 'insurance',
    source_total_rub: detailMoney(206_675.04, { raw: '206 675,04' }),
    detail_total_rub: detailMoney(206_675.04, { raw: '206 675,04' }),
  ...
  detailControlTotal({
    ...
    estimate_row_id: 'landscaping-mowing-ditches',
    cost_bucket: 'overhead',
    source_total_rub: detailMoney(479_048.1, { raw: '479 048,10' }),
    detail_total_rub: detailMoney(479_048.1, { raw: '479 048,10' }),
  ...
  detailControlTotal({
    ...
    estimate_row_id: 'landscaping-mowing-ditches',
    cost_bucket: 'profit',
    source_total_rub: detailMoney(273_741.77, { raw: '273 741,77' }),
    detail_total_rub: detailMoney(273_741.77, { raw: '273 741,77' }),
  ...
  detailControlTotal({
    ...
    source_total_rub: detailMoney(1_816_356, {
      raw: '1 714 658,17 + 15 204,69 + 86 493,14',
    }),
  ...
  detailControlTotal({
    ...
    estimate_row_id: 'landscaping-trees-shrubs',
    cost_bucket: 'primary_salary',
    source_total_rub: detailMoney(415_902.91, { raw: '415 902,91' }),
    detail_total_rub: detailMoney(415_902.92, {
      raw: '25,77 + 302 784,07 + 3 865,33 + 644,22 + 837,49 + 91 318,39 + 16 427,65',
  ...
  detailControlTotal({
    ...
    estimate_row_id: 'landscaping-trees-shrubs',
    cost_bucket: 'machinist_salary',
    source_total_rub: detailMoney(153_163.08, { raw: '153 163,08' }),
    detail_total_rub: detailMoney(153_163.08, { raw: '153 163,08' }),
  ...
  detailControlTotal({
    ...
    estimate_row_id: 'landscaping-trees-shrubs',
    cost_bucket: 'machines',
    source_total_rub: detailMoney(259_733.8, { raw: '259 733,80' }),
    detail_total_rub: detailMoney(259_733.8, { raw: '259 733,80' }),
  ...
  detailControlTotal({
    ...
    estimate_row_id: 'landscaping-trees-shrubs',
    cost_bucket: 'materials',
    source_total_rub: detailMoney(30_965.67, { raw: '30 965,67' }),
    detail_total_rub: detailMoney(30_965.67, { raw: '30 965,67' }),
  ...
  detailControlTotal({
    ...
    estimate_row_id: 'landscaping-trees-shrubs',
    cost_bucket: 'insurance',
    source_total_rub: detailMoney(171_857.92, { raw: '171 857,92' }),
    detail_total_rub: detailMoney(171_857.92, { raw: '171 857,92' }),
  ...
  detailControlTotal({
    ...
    estimate_row_id: 'landscaping-trees-shrubs',
    cost_bucket: 'overhead',
    source_total_rub: detailMoney(398_346.19, { raw: '398 346,19' }),
    detail_total_rub: detailMoney(398_346.19, { raw: '398 346,19' }),
  ...
  detailControlTotal({
    ...
    estimate_row_id: 'landscaping-trees-shrubs',
    cost_bucket: 'profit',
    source_total_rub: detailMoney(227_626.4, { raw: '227 626,40' }),
    detail_total_rub: detailMoney(227_626.4, { raw: '227 626,40' }),
  ...
  detailControlTotal({
    ...
    source_total_rub: detailMoney(1_755_909, {
      raw: '1 657 595,98 + 14 698,31 + 83 614,71',
    }),
  ...
  detailControlTotal({
    ...
    estimate_row_id: 'landscaping-ticks-hogweed',
    cost_bucket: 'contractors',
    source_total_rub: detailMoney(5_860_200, { raw: '5 860 200,00' }),
    detail_total_rub: detailMoney(5_860_200, { raw: '5 860 200,00' }),
  ...
  detailControlTotal({
    ...
    source_total_rub: detailMoney(6_207_773, {
      raw: '5 860 200,00 + 51 964,76 + 295 608,24',
    }),
  ...
  detailControlTotal({
    ...
    estimate_row_id: 'landscaping-forest-care',
    cost_bucket: 'primary_salary',
    source_total_rub: detailMoney(172_154.56, { raw: '172 154,56' }),
    detail_total_rub: detailMoney(172_154.56, { raw: '172 154,56' }),
  ...
  detailControlTotal({
    ...
    estimate_row_id: 'landscaping-forest-care',
    cost_bucket: 'insurance',
    source_total_rub: detailMoney(51_990.68, { raw: '51 990,68' }),
    detail_total_rub: detailMoney(51_990.68, { raw: '51 990,68' }),
  ...
  detailControlTotal({
    ...
    estimate_row_id: 'landscaping-forest-care',
    cost_bucket: 'overhead',
    source_total_rub: detailMoney(120_508.19, { raw: '120 508,19' }),
    detail_total_rub: detailMoney(120_508.19, { raw: '120 508,19' }),
  ...
  detailControlTotal({
    ...
    estimate_row_id: 'landscaping-forest-care',
    cost_bucket: 'profit',
    source_total_rub: detailMoney(68_861.82, { raw: '68 861,82' }),
    detail_total_rub: detailMoney(68_861.82, { raw: '68 861,82' }),
  ...
  detailControlTotal({
    ...
    source_total_rub: detailMoney(438_041, {
      raw: '413 515,26 + 3 666,64 + 20 859,10',
    }),
