  ...
  sections: [
    {
      ...
      rows: [
        estimateRow({
          ...
          description:
            'В этой строке учтены погрузка мусора, работа Газели, зарплата рабочего и зарплата машиниста.',
    ...
    },
    {
      ...
      rows: [
        estimateRow({
          ...
          description:
            'Песок и служебная спецодежда учтены как материалы, техника - как машины и механизмы, труд механизаторов - как зарплата машинистов.',
        ...
        estimateRow({
          ...
          description:
            'Песок, спецодежда и инвентарь учтены как материалы этой строки.',
          tags: ['ручной труд'],
        }),
        estimateRow({
          ...
          description:
            'Вода и спецодежда учтены как материалы, поливомоечная техника - как машины и механизмы.',
          tags: ['машино-часы', 'крупная статья'],
        }),
        estimateRow({
          ...
          description:
            'Спецодежда и инвентарь учтены как материалы этой строки.',
    ...
    },
    {
      ...
      rows: [
        estimateRow({
          ...
          description:
            'Спецодежда учтена как материалы, триммеры - как машины и механизмы.',
        ...
        estimateRow({
          ...
          description:
            'Удобрения, вода, спецодежда и инвентарь учтены как материалы; поливочная техника - как машины и механизмы.',
          tags: ['ручной труд', 'машино-часы'],
        }),
        estimateRow({
        ...
        estimateRow({
          ...
          source_refs: [
            ...
            source(
              ...
              'В детализации благоустройства нет найденной строки ремонта покрытия дорог или площадок; сопоставление с этой строкой не подтверждено.',
            ),
            source(
              'improvement',
              11,
              'локальный расчет, замена поврежденных элементов периметрального ограждения',
              'Материалы 298 320 ₽ близки к строке 4.2 после налоговых начислений, но название работ отличается от final.pdf.',
            ),
            source(
              'improvement',
              12,
          ...
          editable_fields: 'basic',
          description:
            'Сопоставление строки итоговой сметы с детализацией не подтверждено: в final.pdf указано покрытие дорог и площадок, а в детализации благоустройства найдена только близкая по сумме строка ремонта периметрального ограждения. Официальная сумма сохранена по итоговой смете и требует проверки по исходной рабочей книге или у составителя сметы.',
    ...
    },
    {
      ...
      rows: [
        estimateRow({
          ...
          editable_fields: 'basic',
          description:
            'Подрядная охрана и материальные расходы КПП учтены как услуги подрядчиков и материалы.',
          tags: ['подрядная услуга', 'крупная статья'],
        }),
        estimateRow({
    ...
    },
    {
      ...
      rows: [
        estimateRow({
          ...
          description: 'Замена светильников учтена как материалы этой строки.',
          tags: ['ручной труд'],
        }),
        estimateRow({
