        ...
        estimateRow({
          ...
          source_refs: [
            ...
            source(
              ...
              'Страница продолжает строку ремонта периметрального ограждения и подтверждает материальную сумму, использованную в baseline breakdown.',
            ),
          ],
          editable_fields: 'basic',
          description:
            'Сопоставление строки итоговой сметы с детализацией не подтверждено: в final.pdf указано покрытие дорог и площадок, а в детализации благоустройства найдена только близкая по сумме строка ремонта периметрального ограждения. Baseline сохранен по итоговой смете и требует проверки по исходной рабочей книге или у составителя сметы.',
