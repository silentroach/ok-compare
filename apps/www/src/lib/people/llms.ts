    ...
    ? serializeLlmsDocument({
        ...
        sections: [
          llmsSection('Описание', [
            markdownList([
              'Раздел `/people/` публикует публичные профили людей, контакты и граф упоминаний между новостями, статусом, отзывами, другими профилями и сарафаном.',
          ...
          llmsSection('Как читать раздел', [
            markdownList([
              ...
              'В `backlinks` лежат входящие ссылки из новостей, статуса, отзывов, других профилей и сарафана, собранные из тех же канонических и подписанных синтаксисов упоминаний.',
        ...
        sections: [
          ...
          llmsSection('Описание people.json', [
            markdownList([
              ...
              '`backlinks` группируются по `news`, `status`, `reviews`, `people` и `contacts`, чтобы отвечать на вопрос, где человек уже фигурирует на сайте; граф учитывает канонические и подписанные упоминания.',
            ]),
          ]),
