...
export type PersonMentionSection = 'news' | 'status' | 'meetings' | 'people';
export type PersonBacklinkKind = 'article' | 'incident' | 'meeting' | 'person';
...
export interface PersonBacklinks {
  ...
  readonly meetings: readonly PersonMentionRef[];
