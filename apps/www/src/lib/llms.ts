        ...
        sections: [
          ...
          llmsSection('Как ориентироваться', [
            markdownList([
              ...
              `Сарафан: ${contactsMarkdown}; разделы: \`/sarafan/[category]/\` и \`/sarafan/[category]/index.md\`; детальные страницы есть только у контактов с body и используют \`/sarafan/[category]/[slug]/\` и \`/sarafan/[category]/[slug]/index.md\`.`,
        ...
        sections: [
          ...
          llmsSection('Сарафан', [
            markdownList([
              ...
              'Разделы сарафана используют `/sarafan/[category]/` и `/sarafan/[category]/index.md`; детальные страницы есть только у контактов с body и используют `/sarafan/[category]/[slug]/` и `/sarafan/[category]/[slug]/index.md`.',
