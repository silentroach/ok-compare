---
name: site-sections
description: Используй для навигации по корневому сайту и выбора между news, status, people и compare-разделом.
---
...
- `/815/compare/` — сравнение поселков, тарифов и рейтинга; основной feed: `/815/compare/data/settlements.json`.

## Ограничения

- Compare живет внутри основного сайта под `/815/compare/`, а исходники раздела находятся в `apps/www/src/compare`.
- Public skills на корне сейчас покрывают navigation, news, status и people. У compare-раздела есть свой отдельный skill index.
