---
name: site-sections
description: Используй для навигации по корневому сайту и выбора между новостями, статусом, архивом встреч, людьми и сравнением тарифов поселков.
---
...
- Когда нужно быстро найти правильную точку входа для новостей, статуса, архива встреч, профилей людей или сравнения тарифов поселков.
...
- У архива встреч нет JSON-ленты и HTML-индекса раздела; начинай с `/meetings/index.md`.
- Публичные навыки на корне покрывают навигацию, новости, статус, архив встреч и профили людей. У Compare есть свой отдельный индекс навыков.
